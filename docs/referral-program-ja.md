...
年払いは20%OFFなので、スタンダードなら年9,600円＝月あたり800円。ここで定価の1,000円を返すと、**20%OFFと紹介の無料月が二重取り**になり、6人紹介すると年9,600円のうち6,000円が引かれて実質62%OFFになってしまう。

割引後の月あたり額（800円）にすれば、6人でも4,800円＝**ちょうど半額**で、月払いの人と同じ「通算で最大でも半額」に収まる。1つの上限で両方の周期を守れる。
