...
const faqs = [
  ...
  ['探しごとに写真を添えたい', '投稿の画面から写真を1枚まで選べます。写真は端末の中で小さく作り直してから送るので、通信量を抑えられます。一覧では正方形に切り抜いて表示されます。'],
  ...
  ['招待の特典について', '招待した方のご利用が30日続くと、有料プランの方は会費が1ヶ月ぶん安くなり、無料プランの方はスタンダードが1ヶ月使えるようになります（合計6ヶ月ぶんまで）。お手続きは要りません。この特典は、予告なく内容の変更または終了をすることがあります。すでに確定したぶんは、そのままご利用いただけます。'],
