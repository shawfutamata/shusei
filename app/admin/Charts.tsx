...
const series = [
  ...
  { key: 'requests', label: '案件', color: 'var(--viz-2)' },
  ...
  return <figure className="viz">
    ...
    <div className="viz-scroll">
      ...
      <svg viewBox={`0 0 ${width} ${height}`} className="viz-svg"
        ...
        aria-label={`期間中の推移。新しい会員 ${totals[0].total}件、案件 ${totals[1].total}件、オファー ${totals[2].total}件。`}
    ...
    <figcaption className="viz-caption">
      ...
      <span className="viz-caption-values">新しい会員 {active.members}／案件 {active.requests}／オファー {active.introductions}</span>
