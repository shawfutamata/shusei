...
const title = 'TASUKI｜守成クラブ会員向けの招待制ビジネスマッチング';
const description = 'TASUKIは守成クラブ会員向けの招待制ビジネスマッチングサービス。案件の投稿・会員検索・知り合いの紹介から、新しい商売や協業のきっかけをつなぎます。無料プランあり。招待コードとGoogleアカウントで登録できます。';
...
export const lpStructuredData = {
  '@context': 'https://schema.org', '@graph': [
    ...
    { '@type': 'Service', '@id': `${lpUrl}#service`, name: 'TASUKI', serviceType: '招待制ビジネスマッチングサービス', description, url: lpUrl, areaServed: { '@type': 'Country', name: 'Japan' }, audience: { '@type': 'BusinessAudience', audienceType: '守成クラブ会員' }, provider: { '@id': `${serviceUrl}/#organization` } },
  ],
};
