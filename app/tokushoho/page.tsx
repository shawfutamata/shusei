...
export default function TokushohoPage() {
  ...
  const rows: [string, React.ReactNode][] = [
    ...
    ['支払時期', <>
      ...
      広告の出稿枠は、お申し込み手続きの完了時に、掲載日数分の1回きりのご請求を行います。自動更新はありません。
    </>],
  ...
  >
    ...
    <LegalSection
      heading="価格の内訳"
      body={[
        `年払いは、月払いの12か月分から20%を割り引いた金額です。スタンダードは月あたり ${Math.round(yearlyYen('standard') / 12).toLocaleString('ja-JP')}円になります。`,
        '広告の出稿枠は、1回きりのお支払いです。掲載期間はお申し込み時に7日から30日の範囲でお選びいただき、自動更新はありません。枠数には限りがあり、お申し込み順に確定します。',
