...
export const AppColors = { blue: '#1478D6', blueDark: '#0F5FC4', sky: '#46C6FB', accent: '#F4501E', accentInk: '#C93D0E', accentSoft: '#FFF3EE', accentLine: '#FAC9B4', ink: '#13233F', muted: '#66758C', line: '#DCE5F2', paper: '#F5F8FD', white: '#FFFFFF', paleBlue: '#EAF3FF' };
