...
export const rankPerks: RankPerk[] = [
  { key: 'extend', label: '募集の延長', minLevel: 2, detail: '期限が来た案件を、1件につき1回だけ2週間延ばせます。もう少し待てば見つかりそうなときに。' },
  { key: 'longtext', label: '掲載文章の上限なし', minLevel: 2, detail: '案件の本文が600字までの制限から外れ、いくらでも書けるようになります。背景や条件を省かずに伝えられます。' },
  { key: 'industries', label: 'おすすめ業種を10枠', minLevel: 2, detail: 'ホームの「あなたにおすすめ」に出す業種が、6個から10個に増えます。守備範囲の広い方ほど効きます。' },
  { key: 'photos', label: '写真の複数枚投稿', minLevel: 3, detail: '案件に付けられる写真が1枚から5枚に増えます。現場や商品を何枚も見せられます。' },
  { key: 'video', label: '動画を投稿できる', minLevel: 3, detail: '案件に短い動画を付けられるようになります。大きい動画は送る前に端末側で自動的に縮めるので、通信量を気にせず選べます。' },
  { key: 'budget', label: '予算での絞り込み', minLevel: 3, detail: '仕事の掲示板を、その案件の予算で絞り込めます。年商が大きくても案件の予算が小さければ意味がないので、物差しは会社の規模ではなく予算にしてあります。' },
];
