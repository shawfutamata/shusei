...
export type MemberStats = { displayName: string; venue: string; introCount: number; points: number; rank: string; level: number; nextRankAt: number };
...
export const demoStats: MemberStats = { displayName: '二俣 将', venue: 'ひるのめぐろ会場', introCount: 0, points: 0, rank: 'PEARL', level: 1, nextRankAt: 3 };
