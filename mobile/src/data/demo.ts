...
export type MemberStats = { displayName: string; venue: string; introCount: number; inviteCount: number; points: number; rank: string; level: number; nextRankAt: number };
...
// ランクは招待して参加した仲間の人数で上がる。次は1人でGOLD。
export const demoStats: MemberStats = { displayName: '二俣 将', venue: 'ひるのめぐろ会場', introCount: 0, inviteCount: 0, points: 0, rank: 'SILVER', level: 1, nextRankAt: 1 };
