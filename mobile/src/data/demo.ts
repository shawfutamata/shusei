...
export type MemberStats = { displayName: string; venue: string; introCount: number; inviteCount: number; rank: string; level: number; nextRankAt: number };
...
export const demoStats: MemberStats = { displayName: '二俣 将', venue: 'ひるのめぐろ会場', introCount: 0, inviteCount: 0, rank: 'SILVER', level: 1, nextRankAt: 1 };
